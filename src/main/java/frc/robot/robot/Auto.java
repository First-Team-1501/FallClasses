...
NamedCommands.registerCommand("ShooterHighSpeed",new ShootSpeedCommand(shooter, 1));
NamedCommands.registerCommand("StopShooter",new ShootSpeedCommand(shooter, 0));
NamedCommands.registerCommand("ArmToZero",new ArmPositonCommand(arm,0));
